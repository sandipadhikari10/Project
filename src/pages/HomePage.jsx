    ...
    <div>
      ...
      <div className="mt-25 bg-gray-100 grid   md:grid-cols-2  ">
        ...
        <div className="max-w-xl mt-20 cursor-pointer  ">
          ...
          {/* Event Card */}
          <div className="bg-white shadow-lg  w-120 h-50  p-6 flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
            {/* Left - Date Section */}
          ...
          {/* More Events Button */}
          <div className="mt-6 ">
            <button className="bg-[#0884DC] text-white px-8 py-3 cursor-pointer rounded-lg text-lg font-semibold hover:bg-blue-700 transition">
              More Events
            </button>
          </div>
        </div>
      ...
      <div className="bg-gray-100  ">
        ...
        {/* <span className="flex justify-end px-48 hover:pointer">
          <button
            onClick={() => navigate("/executive-members")}
